    ...
    const testimonials1: TestimonialData[] = [
      {
        ...
        content:
          "I'm using @SyncSpace_App for our team projects and the role-based permissions are a game-changer. No more access confusion!",
        highlight: "@SyncSpace_App",
      },
      {
        name: "Michael Chen",
        handle: "@mchen_tech",
        ...
        content:
          "Switched from Dyla to @SyncSpace_App and our team productivity increased by 40%. The Kanban board view is incredibly intuitive.",
        highlight: "@SyncSpace_App",
      },
      {
        ...
        avatar: "/female-icon.jpg?height=48&width=48",
        content:
          "The real-time chat in @SyncSpace_App eliminated our need for chat_App. One platform for everything = less context switching!",
        highlight: "@SyncSpace_App",
      },
      {
        name: "David Kim",
        ...
        avatar: "/placeholder.jpg?height=48&width=48",
        content:
          "Our remote team relies on @SyncSpace_App for everything. The file management system has been crucial for our design handoffs.",
        highlight: "@SyncSpace_App",
      },
      {
        name: "Jessica Taylor",
        ...
        avatar: "/female-icon.jpg?height=48&width=48",
        content:
          "Just migrated our entire project tracking to @SyncSpace_App and it's been a game changer. The dashboard gives me the perfect overview.",
        highlight: "@SyncSpace_App",
      },
    ];
    ...
    const testimonials2: TestimonialData[] = [
      {
        ...
        avatar: "/placeholder.jpg?height=48&width=48",
        content:
          "As a CTO, I appreciate how @SyncSpace_App handles permissions. The three-tier system (Admin, Editor, Member) is exactly what we needed.",
        highlight: "@SyncSpace_App",
      },
      {
        ...
        avatar: "/female-icon.jpg?height=48&width=48",
        content:
          "The UI of @SyncSpace_App is so clean and intuitive. As a UX designer, I'm impressed by how they've simplified complex workflows.",
        highlight: "@SyncSpace_App",
      },
      {
        name: "James Thompson",
        ...
        avatar: "/placeholder.jpg?height=48&width=48",
        content:
          "We've been using @SyncSpace_App for our sprints since March, and it's been an absolute joy. The task tracking and calendar features are perfect.",
        highlight: "@SyncSpace_App",
      },
      {
        name: "Olivia Parker",
        ...
        avatar: "/female-icon.jpg?height=48&width=48",
        content:
          "@SyncSpace_App has the best email notification system. Never miss an update, but also not overwhelmed with alerts. Perfect balance!",
        highlight: "@SyncSpace_App",
      },
      {
        name: "Daniel Lee",
        ...
        avatar: "/placeholder.jpg?height=48&width=48",
        content:
          "Moving from Apex to @SyncSpace_App was the best decision we made this year. Better UI, faster performance, and the Socket.IO integration is brilliant.",
        highlight: "@SyncSpace_App",
      },
    ];
          ...
          <div className="flex items-center mb-2 sm:mb-3">
            <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full overflow-hidden mr-2 sm:mr-3 bg-gray-100 dark:bg-zinc-800">
              <Image
                ...
                onClick={() => {
                  window.location.href = "https://github.com/syncspace-admin";
                }}
              />
            </div>
            <div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="mt-3 sm:mt-4 max-w-2xl text-base sm:text-lg text-gray-600 dark:text-zinc-400 mx-auto px-2">
              See what users have to say about how SyncSpace has transformed their
              workflow.
            </p>
          </div>
